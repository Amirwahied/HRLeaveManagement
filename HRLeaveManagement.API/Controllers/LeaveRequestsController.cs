...
namespace HRLeaveManagement.API.Controllers
{
    ...
    public class LeaveRequestsController : ControllerBase
    {
        ...
        {
            var leaveRequests = await _mediator.Send(new GetLeaveRequestsListQueryRequest());
        ...
        {
            var leaveRequest = await _mediator.Send(new GetLeaveRequestDetailQueryRequest(id));
